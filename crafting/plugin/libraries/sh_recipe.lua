...
function CLASS_TABLE:PlayerCanCraftRecipe(player, inventory)
	...
	if (self.flag and !Clockwork.player:HasAnyFlags(player, self.flag)) then
		return false, "You do not have the "..self.flag.." flag.";
	end;
	...
	if (self.tools) then
		...
		if (bCanCraft == false) then
			return false, err or "You do not have the required tools to craft this.";
		end;
	end;
	...
	if (self.ingredients) then
		...
		if (bCanCraft == false) then
			return false, err or "You do not have the required ingredients to craft this.";
		end;
	end;
	...
	if (self.station) then
		...
		if (bCanCraft == false) then
			return false, err or "You are not near the correct crafting station.";
		end;
	end;
	...
	if (self.PlayerCanCraft) then
		...
		if (bCanCraft == false) then
			return false, err or "You cannot craft this.";
		end;
	end;
