...
ITEM.name = "UU-Branded Cornflakes";
ITEM.uniqueID = "uu_branded_cornflakes";
ITEM.cost = 5;
...
ITEM.business = true;
ITEM.description = "Nice things to eat with milk.";
ITEM.hunger = 20;
ITEM.thirst = -10;
...
function ITEM:OnUse(player, itemEntity)
	...
	player:GiveItem(Clockwork.item:CreateInstance("empty_uu_cornflakes"));
end;
