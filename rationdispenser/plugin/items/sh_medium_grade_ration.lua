...
ITEM.useText = "Open";
ITEM.description = "A ration package for CWU workers.";
...
function ITEM:OnUse(player, itemEntity)
	Clockwork.player:GiveCash(player, 50, "medium_grade_ration");
	
	player:GiveItem(Clockwork.item:CreateInstance("uu_branded_loyalist_supplements"), true);
	player:GiveItem(Clockwork.item:CreateInstance("uu_smooth_breens_water"), true);
